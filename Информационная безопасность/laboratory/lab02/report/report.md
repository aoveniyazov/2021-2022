...
![Создание учетной записи](image/img(1).png){ #fig:001 width=70% }

Выполнил вход в систему от имени пользователя guest

![Вход в систему](image/img(2).png){ #fig:002 width=70% }

Определил директорию где я нахожусь командой pwd. Нахожусь в домашней директории

![Результат pwd](image/img(3).png){ #fig:003 width=70% }

Уточнил имя текущего пользователя командой whoami.

![Результат whoami](image/img(4).png){ #fig:004 width=70% }
...
![Результат id и groups](image/img(5).png){ #fig:005 width=70% }
...
![Результат /etc/passwd | grep guest](image/img(6).png){ #fig:006 width=70% }
...
![Результат ls -l и lsattr /home/](image/img(7).png){ #fig:007 width=70% }
